...
# These 3 lines of code are an example of how we would accomplish a multi-step analysis based on what we've learned so far. 
...
covid_testing %>% 
  ...
  arrange(________)    #Here arrange the pan_day column from highest to lowest (HINT: See the arrange section of this file to see how to use the desc() function)
```
